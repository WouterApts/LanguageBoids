...
Boid::Boid(Eigen::Vector2f pos, Eigen::Vector2f vel, Eigen::Vector2f acc,
    ...
    //TODO Split into CompetitionBoid and EvolutionBoid
}
...
/* Competition Boid */
void CompBoid::UpdateLanguage(const std::vector<Boid *> &boids, sf::Time delta_time) {
}

void CompBoid::UpdateAcceleration(const std::vector<Boid *> &nearby_boids, World &world) {
}
